...
glm::vec3 vCubeVertices3[12] =
{
	...
	//// Bottom face
	//glm::vec3(0.5f, -0.5f, -0.5f), glm::vec3(-0.5f, -0.5f, -0.5f), glm::vec3(0.5f, -0.5f, 0.5f), glm::vec3(-0.5f, -0.5f, 0.5f),
	glm::vec3(0.5f, -0.5f, -0.5f), // 7 == 8
	glm::vec3(-0.5f, 0.5f, 0.5f), // 2 == 9
	glm::vec3(-0.5f, -0.5f, -0.5f), // 5 == 10
	glm::vec3(0.5f, 0.5f, 0.5f),  // 0 == 11
};
...
glm::vec2 vCubeTexCoords3[4] = { glm::vec2(0.0f, 0.0f), glm::vec2(0.0f, 1.0f), glm::vec2(1.0f, 0.0f), glm::vec2(1.0f, 1.0f),};
...
int iTorusFaces1, iTorusFaces2, iCylinderFaces1, iCylinderFaces2;
...
void AddSceneObjects(CVertexBufferObject& vboDest)
{
	...
	iTorusFaces1 = GenerateTorus(vboDest, 7.0f, 2.0f, 20, 20);
	iTorusFaces2 = GenerateTorus(vboDest, 3.0f, 1.0f, 20, 20);
	iCylinderFaces1 = GenerateCylinder(vboDest, 10.0f, 15.0f, 20, 1.0, 1.0);
	iCylinderFaces2 = GenerateCylinder(vboDest, 1.0f, 0.5f, 20, 1.0, 1.0);
...
void AddCube(CVertexBufferObject& vboDest)
{
	...
	// add 4 extra points to specify UV
	FOR(i, 12)
	{
		vboDest.AddData(&vCubeVertices3[i], sizeof(glm::vec3));
		vboDest.AddData(&vCubeTexCoords3[i%4], sizeof(glm::vec2));
